...
SECRET_KEY = 'django-insecure-4vu=tq@#mj^d1e+7)wqf9sz&wsrahdf9jr9%#r$ox(#m-s43%b'
...
if REDIS_HOST and REDIS_KEY:
    CELERY_BROKER_URL = f"rediss://:{REDIS_KEY}@{REDIS_HOST}:{REDIS_PORT}/1?ssl_cert_reqs=CERT_NONE"
